...
public class Board {
    ...
    public boolean move(int col, int row, Tile tile) {
        /** Obtain the standard position using perspective.col/row */
        /**
         * Check if the input tile is at where of this col and row
         */
        ...
        /**
         * Create a tile and assign it with null to the
         * The input tile is what exactly....
         * If tile1 is the tile at this position.
         *
         * In this step, it removes set the current position of the board to null,
         */
        ...
        /**
         * The tile and tile 1 are where?
         *
         * If the target is null then it returns false(not a merge)
         *
         * if it's null, create a tile at certain position, set current tile's next to this tile
         *
         * or maybe just try to use move and see how much it does.
         *
         * setNext does what exactly...
         */
        if (tile1 == null) {
